...
return [
    ...
    'deposit' => [
        ...
        'waiting' => 'มีรายการรอดำเนินการอยู่',
        ...
        'deposit_note' => '*หลังจากที่โอนเงินเสร็จแล้ว ให้ระบุจำนวนที่โอน แล้วกดยืนยันการฝาก',
    ],
    'dialog' => [
        'confirm_btn' => 'ตกลง',
        'cancel_btn' => 'ยกเลิก',
    ...
    'forgot' => [
        ...
        'otp_note' => '*หากไม่ได้รับ SMS OTP ภายใน 1 นาที กรุณาติดต่อเจ้าหน้าที่',
        'confirm' => 'ยืนยัน',
        'otp_ref' => 'รหัสอ้างอิง: ',
        ...
        'contact_us' => 'ติดต่อเจ้าหน้าที่',
        'reset_password_is_succeed' => 'เปลี่ยนรหัสผ่านใหม่สำเร็จ กรุณารอสักครู่',
    ],
    'history' => [
    ...
    'home' => [
        ...
        'have_not_user_yet' => 'ยังไม่รับเว็บยูสเซอร์',
    ],
    'lucky_wheel' => [
    ...
    'profile' => [
        ...
        'affiliate' => 'แนะนำเพื่อน',
        'contact_us' => 'ติดต่อเจ้าหน้าที่',
        'have_not_user_yet' => 'ยังไม่รับยูสเซอร์',
        'have_not_pass_yet' => 'ยังไม่รับรหัสผ่าน',
    ],
    'promotion' => [
        'promotion' => 'โปรโมชั่น',
    ...
    'register' => [
        ...
        'verify_bank_account_name' => 'กรุณาระบุชื่อบัญชีให้ตรงกับเลขบัญชี',
        'verify_done' => 'สำเร็จ',
        'confirm' => 'ยืนยัน',
        'register_is_succeed' => 'สมัครสมาชิกสำเร็จ กรุณารอสักครู่',
        'have_account_yet' => 'ยังไม่มีบัญชี?',
        'register_now' => 'สมัครเลย',
        'have_account' => 'มีบัญชีผู้ใช้อยู่แล้ว?',
    ...
    'withdraw' => [
        ...
        'amount_is_not_comma' => 'ไม่ต้องใส่เครื่องหมายคอมม่า ( , )',
    ],
    "wheel" => [
        "title" => "Lucky Wheel",
        "CLAIMABLE" => "รอรับโบนัส",
        "CLAIMED" => "รับโบนัสแล้ว",
    ],
    "checkin" => [
        "title" => "Checkin Daily",
        "CLAIMABLE" => "รอรับโบนัส",
    ...
    "lotto" => [
        ...
        "number" => "หมายเลข",
        "point" => "แต้ม",
        "remark" => "( ใช้ {0} แต้ม ในการซื้อ )",
        "bingo" => "เลขที่ออก",
        "wait" => "รอผล",
        "win" => "ถูกรางวัล",
        "lose" => "ไม่ถูกรางวัล",
        "history" => "ประวัติการซื้อ",
        "confirm" => "ยืนยันการซื้อหมายเลข",
        "disable" => "ยังไม่เปิดให้บริการ",
    ],
    'error' => [
        'back_btn' => 'กลับ',
